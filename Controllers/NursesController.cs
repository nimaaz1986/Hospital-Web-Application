...
namespace Lab5_Hospital.Controllers
{
    public class NursesController : Controller
    {
        ...
        public NursesController(PatientContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender")] Nurse nurse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender")] Nurse nurse)
        {
            if (id != nurse.Id)
            {
                return NotFound();
